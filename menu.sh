...
echo -e "${BB}╠════════════════════════════════════════════════════════════╣${NC}"
echo -e "  ${RB}1.${NC} ${YB}XRAY VMESS WS     ${WB}[${GB}${vmess}${WB}]${NC}     🌀"
echo -e "  ${RB}2.${NC} ${YB}XRAY VLESS WS     ${WB}[${GB}${vless}${WB}]${NC}     📡"
echo -e "  ${RB}3.${NC} ${YB}XRAY TROJAN WS    ${WB}[${GB}${trws}${WB}]${NC}     🛡️"
echo -e "  ${RB}4.${NC} ${YB}XRAY TROJAN XTLS  ${WB}[${GB}${txtls}${WB}]${NC}     🔐"
echo -e "  ${RB}5.${NC} ${YB}XRAY TROJAN TCP   ${WB}[${GB}${tr}${WB}]${NC}     🧰"
echo -e "${BB}╠════════════════════════════════════════════════════════════╣${NC}"
echo -e "                      ${WB}🛠️  Menu VPS 🛠️${NC}"
echo -e "${BB}╠════════════════════════════════════════════════════════════╣${NC}"
echo -e "  ${RB}6.${NC} ${YB}PASANG PEMBLOKIR IKLAN               🚫"
echo -e "  ${RB}7.${NC} ${YB}PASANG TCP BBRPLUS                  🚀"
echo -e "  ${RB}8.${NC} ${YB}MENU PEMBLOKIR IKLAN                🧹"
echo -e "  ${RB}9.${NC} ${YB}GANTI DNS                           🧬"
...
echo -e "  ${RB}17.${NC} ${YB}CEPAT UJI JARINGAN (Speedtest)     ⚡"
