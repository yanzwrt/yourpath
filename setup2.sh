...
clear
#echo -e "${red}♦️${NC} ${green}Established By Rakha-VPN 2022${NC} ${red}♦️${NC}"
...
read -rp "masukan Domain anda : " domen 
...
#wget -q -O /usr/share/nginx/html/index.html "https://raw.githubusercontent.com/yanzwrt/yourpath/main/OTHERS/index.html"
